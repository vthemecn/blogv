...
match:[/class/,/\s+/,b,/\s+/,/inc/,/\s+/,l.concat(b,"(",l.concat(/\./,b),")*")],
...
match:[/class/,/\s+/,d,/\s+/,/inc/,/\s+/,l.concat(d,"(",l.concat(/\./,d),")*")],
scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{
...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `php` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
}})();hljs.registerLanguage("php",e)})();/*! `scss` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
