        ...
        <tbody>
            <tr>
                ...
                <td>
                    <p>
                        <label>
                            <input name="is_development" type="radio" value="1" <?php if ($rt_config['is_development'] == 1) { ?>checked="checked" <?php } ?>>
                            开启
                        </label>
                        <label>
                            <input name="is_development" type="radio" value="0" <?php if ($rt_config['is_development'] == 0) { ?>checked="checked" <?php } ?>>
                            关闭
                        </label>
                    </p>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="upload_images_limit" id="upload_images_limit" value="<?php echo ($rt_config['upload_images_limit']); ?>" class="regular-text" placeholder="请输入微信手机号">
            ...
            <tr>
                ...
                <td>
                    <?php
                    $account_mode = is_array($rt_config['account_mode']) ? $rt_config['account_mode'] : json_decode($rt_config['account_mode'], true);
                    ?>
                    <p>
                        <label>
